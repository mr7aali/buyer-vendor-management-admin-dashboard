  ...
  return <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
      ...
      <div className="relative pl-4 space-y-8 before:absolute before:left-[23px] before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-100">
        ...
        return <div key={index} className="relative flex items-start gap-4">
              <div className={`relative z-10 w-8 h-8 rounded-full flex items-center justify-center border-2 ${index === 0 ? 'bg-white border-[#278687] text-[#278687]' : 'bg-gray-50 border-gray-200 text-gray-400'}`}>
