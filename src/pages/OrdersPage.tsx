...
export function OrdersPage() {
  ...
  //     destination: "USA",
  //     type: "Domestic",
  //   } as any, // Using as any for 'Deleted' status testing fallback
  // ];
  ...
  //       return "in-progress";
  //     case "shipped":
  //       return "in-progress"; // Or 'active' depending on preference
  //     case "delivered":
  //       return "completed";
  //     case "completed":
  //       return "completed";
  ...
  // Assuming StatusType is something like:
  // type StatusType = "pending" | "in-progress" | "completed" | "cancelled" | "failed";
